    ...
    *,
    ...
    return {
        ...
        "serpapi": {
            ...
            "role": (
                "Live-context boundary for claims whose truth depends on current or "
                "public market state. SerpApi results can hold or downgrade release "
                "for human review; they never upgrade an unsupported source claim."
            ),
            "scans": serp_scans,
        },
        "claims": finalized,
        "release_rule": (
            ...
            "If live public context was required and scanned, it must also be "
            "explicitly cleared by a human. SerpApi evidence cannot turn a source-"
            "unsupported claim into an admitted claim."
        ),
    }
